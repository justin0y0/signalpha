...
⚠️ **关键在于 Directional 那一列的样本量**。线上当前实测：

| 阈值 | 3 分类准确率 | 样本 | Directional | Directional 样本 |
|---|---|---|---|---|
| 全部 | 49.3% | 5,477 | 53.5% | **71** |
| ≥0.55 | 61.3% | 1,863 | 53.8% | 65 |
| ≥0.65 | 61.3% | 545 | 57.1% | 42 |
| ≥0.75 | 57.0% | 342 | — | — |

准确率随置信度明显上升（49.3%→61.3%），**但那几乎全部来自 FLAT 判断**——模型只在 2.5% 的事件上给方向，Directional 样本从 71 一路缩到 42，这个量级的百分比没有统计意义。

**正确读法：模型越有把握，越是在说"这次不会有事"，而不是"会涨/会跌"。**
